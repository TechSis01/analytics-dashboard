      ...
      <div className=" mmtablets:h-80 overflow-y-auto custom-scrollbar px-2">
        ...
        <div className="my-5">
          ...
          <div className="w-full h-2 bg-gray-scale rounded-md">
            <div className="bg-red-600 rounded-md w-3/12 h-1"></div>
          </div>
          <div className="flex justify-between items-center">
            <p className="mt-2 fold:text-xs mobile:text-base mtablets:text-lg">
              $600,000
        ...
        <div className="my-5">
          ...
          <div className="w-full h-2 bg-gray-scale rounded-md">
            <div className="bg-indigo-900 rounded-md w-1/5 h-1"></div>
          </div>
          <div className="flex justify-between items-center">
            <p className="mt-2 fold:text-xs mobile:text-base mtablets:text-lg">
              $500,000
        ...
        <div className="my-5">
          ...
          <div className="w-full h-2 bg-gray-scale rounded-md">
            <div className="bg-purple-500 rounded-md w-1/6 h-1"></div>
          </div>
          <div className="flex justify-between items-center">
            <p className="mt-2 fold:text-xs mobile:text-base mtablets:text-lg">
              $400,000
        ...
        <div className="my-5">
          ...
          <div className="w-full h-2 bg-gray-scale rounded-md">
            <div className="bg-green-500 rounded-md w-1/12 h-1"></div>
          </div>
          <div className="flex justify-between items-center ">
            <p className="mt-2 fold:text-xs mobile:text-base mtablets:text-lg">
              $300,000
