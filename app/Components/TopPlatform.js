...
const TopPlatform = () => {
  return (
    <section className='flex flex-col justify-around mt-3 tablets:mt-0 fold:mx-3 mmtablets:mx-5 bg-white  dark:bg-coolors-gray rounded-md fold:p-2 mtablets:p-5 '>
         <div >
            <p className='fold:text-xs mobile:text-base mtablets:text-lg font-semibold py-2'>Top Platform</p>
        </div>
        <div className='my-2'>
            <h2 className='fold:text-xs mobile:text-base mtablets:text-lg font-semibold my-2'>Book Bazaar</h2>
        ...
        <div className='my-2'>
        <h2 className='fold:text-xs mobile:text-base mtablets:text-lg font-semibold my-2'>Artisan Aisle</h2>
        ...
        <div className='my-2'>
        <h2 className='fold:text-xs mobile:text-base mtablets:text-lg font-semibold my-2'>Toy Troop</h2>
        ...
        <div className='my-2'>
        <h2 className='fold:text-xs mobile:text-base mtablets:text-lg font-semibold'>XStore</h2>
