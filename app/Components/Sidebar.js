...
{/* DESKTOP */}
    <div
    className="fixed hidden mtablets:flex top-0 left-0 flex-col items-center justify-between w-16  bg-gray-scale dark:bg-black pt-5 border-r border-gray-300 dark:border-gray-700 h-screen">
      <div >
        <div className="flex justify-center items-center my-1">
          <Image src={logo} alt="logo" width={30} height={20}></Image>
        </div>
